export default [
   ...
   //3.
  {
    ...
    "facts": {
    "longevity": "Alrededor de 24 años",
   ...
   //5.
  {
   ...
   "facts": {
   "longevity": "Alrededor de 28 años",
...
//7.
{
 ...
 //11.
 {
  ...
  "description": "El tiburón linterna (Isistius brasiliensis) es una especie fascinante que habita en las profundidades abisales de los océanos. Dotado de órganos fotóforos, emite una luz tenue que le sirve para atraer a sus presas en la oscuridad. Su mandíbula prominente alberga filas de pequeños dientes afilados, facilitando la captura de peces y calamares. A pesar de su diminuto size, desempeña un papel crucial en el equilibrio ecológico de su hábitat. Este tiburón nocturno, solitario por naturaleza, representa un enigma biológico para los científicos marinos, quienes continúan estudiando su comportamiento y adaptaciones únicas.",
  "facts": {
   "longevity": "Hasta 25 años",
  ...
  "size": "Alcanza hasta 50 cm de longitud."
  },
  //12.
  {
    ...
    "description": "El tiburón linterna negro (Etmopterus spinax) es una criatura asombrosa de las profundidades marinas. Su piel oscura, punteada con puntos luminosos, le otorga un aspecto misterioso. Este depredador nocturno se aventura en las frías aguas del Atlántico, cazando pequeños peces y crustáceos con astucia. A pesar de su size modesto, su longevity sorprende a los científicos, pudiendo alcanzar hasta medio siglo de vida. Adaptado a la vida en las tinieblas del abismo, el tiburón linterna negro es un testimonio de la diversidad y la maravilla de los océanos.",
    "facts": {
     "longevity": "Alrededor de 50 años",
    ...
    "size": "Alcanza hasta 60 cm de longitud."
    },
    //13. 
  {
    ...
    "size": "Alcanza hasta 1 metro de longitud."
    },
    //14.
  {
    "id": "sphyrna_mokarran",
    ...
    "facts": {
     "longevity": "Alrededor de 20-30 años",
    ...
    "size": "Alcanza hasta 6 metros de longitud."
    },
    //15.
  {
    ...
    "facts": {
     "longevity": "Alrededor de 30 años",
    ...
    "size": "Alcanza hasta 3.5 metros de longitud."
    },
     //16.
  {
    "id": "sphyrna_tudes",
    ...
    "size": "Hasta 4 metros de longitud"
   },
   //17.
  {
    ...
    "size": "Alrededor de 1.5 metros de longitud"
   },
   //18.
  {
    ...
    "size": "Alrededor de 1 metro de longitud"
   },
   //19.
  {
    ...
    "shortDescription": "Tiburón depredador de gran size, conocido por su coloración blanca y ataques a mamíferos marinos.",
    ...
    "size": "Más de 6 metros de longitud"
   },
   //20.
   {
    "id": "sphyrna_spp",
    ...
    "facts": {
    "longevity": "Varía según la especie, hasta 30 años",
    ...
    "size": "Varía según la especie, desde 1.5 hasta 6 metros de longitud"
   },
   //21.
   {
   ...
   
   {
    ...
    "description": "El tiburón bambú, Chiloscyllium punctatum, es un tiburón pequeño y de aspecto peculiar, con un cuerpo alargado y patrones de manchas únicos. Se encuentra en aguas tropicales poco profundas del océano Indo-Pacífico. Es un tiburón nocturno que se esconde entre los arrecifes de coral y los lechos marinos durante el día, y se aventura a cazar por la noche. Se alimenta principalmente de crustáceos, peces pequeños y moluscos. Aunque su size y comportamiento generalmente lo mantienen fuera del alcance humano, es capturado accidentalmente en la pesca comercial y la acuicultura.",
    "facts": {
    "longevity": "Hasta 25 años",
